...
![Java](https://img.shields.io/badge/Java-22%2B-orange)

---

**Level Zero** is a Java-based RPG game focused on combat, and gearing up.
...
```bash
git clone https://github.com/Zeteox/Level-Zero.git
cd src/com/levelzero
javac Main.java
java Main
```
